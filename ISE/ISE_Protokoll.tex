...
}Bestimmung des Wertes für $\kappa$ für ein einatomiges (Argon), ein zweiatomiges ($N_2$) und ein dreiatomiges Gas ($CO_2$) durch Messung der Eigenfrequenzen eines Gasoszillators.
Vergleich der Ergebnisse untereinander und mit den erwarteten Werten aus der kinetischen Gastheorie für ein ideales Gas.
\section{Geräteliste}
